...
VALUES (
    ...
    '[{"name": "기술 역량", "description": "Java/Spring 생태계 이해도 40%"}, {"name": "문제 해결 능력", "description": "시스템 설계 및 최적화 30%"}, {"name": "커뮤니케이션", "description": "팀 협업 능력 20%"}, {"name": "경력", "description": "관련 실무 경험 10%"}]',
    'OPEN',
    NOW(6),
    NOW(6),
    NOW(6),
...
VALUES (
    ...
    '[{"name": "기술 역량", "description": "React/Next.js 숙련도 35%"}, {"name": "UI/UX 감각", "description": "디자인 시스템 구축 경험 25%"}, {"name": "문제 해결", "description": "성능 최적화 능력 25%"}, {"name": "팀 협업", "description": "커뮤니케이션 역량 15%"}]',
    'OPEN',
    NOW(6),
    NOW(6),
    NOW(6),
...
VALUES (
    ...
    '[{"name": "풀스택 역량", "description": "프론트/백엔드 통합 개발 30%"}, {"name": "주도성", "description": "기획부터 배포까지 리드 30%"}, {"name": "실행 속도", "description": "빠른 프로토타이핑 능력 20%"}, {"name": "성장 잠재력", "description": "학습 및 적응 능력 20%"}]',
    'OPEN',
    NOW(6),
    NOW(6),
    NOW(6),
