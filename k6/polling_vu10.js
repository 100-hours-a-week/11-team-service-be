/**
 * 폴링 방식 베이스라인 측정 - VU 10명
 *
 * 목적: HTTP 폴링 구조의 불필요한 요청 낭비를 수치로 확인
 *       (대화가 없어도 주기마다 요청이 발생하는 구조적 문제)
 *
 * 조건:
 *   - VU: 10명
 *   - Duration: 30s
 ...
 *
 * 실행:
 *   k6 run k6/polling_vu10.js
 *
 * 결과 파일:
 *   k6/polling_vu10_result.json
 */
...
export function handleSummary(data) {
    ...
    return {
        'k6/polling_vu10_result.json': JSON.stringify(data, null, 2),
